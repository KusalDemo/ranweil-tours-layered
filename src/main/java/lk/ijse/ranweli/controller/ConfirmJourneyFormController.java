    ...
    public void btnConfirmJourneyOnAction(ActionEvent actionEvent) {
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == buttonTypeYes) {
                try {
                    boolean isAvailabilityReset = paymentBo.resetAvailability(txtSelectedVehicle.getText(), txtSelectedHotel.getText(), txtSelectedGuide.getText(), txtSelectedDriver.getText());
